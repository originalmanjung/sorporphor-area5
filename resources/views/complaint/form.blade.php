    ...
    <section id="breadcrumbs" class="breadcrumbs">
        <div class="container">
            <div class="d-flex justify-content-between align-items-center">
                <h2>รับเรื่องร้องเรียน</h2>
                <ol>
                    <li><a href="{{ route('home') }}">หน้าหลัก</a></li>
                    <li><a href="{{ route('complaints.index') }}">ช่องทางรับเรื่องร้องเรียน</a></li>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="row g-2">
                                <div class="mb-3">
                                    ...
                                    <input type="number"
                                        class="form-control form-control-sm @error('idCardnumber') is-invalid @enderror"
                                        id="idCardnumber" name="idCardnumber" value="{{ old('idCardnumber') }}">
                                    @error('idCardnumber')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="row g-2">
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control form-control-sm @error('address') is-invalid @enderror" id="address"
                                        name="address" rows="5">{{ $complaint->address ?? old('address') }}</textarea>
                                    @error('address')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
