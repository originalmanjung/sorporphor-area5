...
<div id="comment-{{ $comment->getKey() }}" class="media">
    <img class="mr-3" width="40" height="40" src=" @if(isset($comment->commenter->avatar)) {{ asset('storage/user_avatars/'.$comment->commenter->avatar) }} @else https://www.gravatar.com/avatar/{{ md5($comment->commenter->email ?? $comment->guest_email) }}.jpg?s=54 @endif" alt="{{ $comment->commenter->name ?? $comment->guest_name }} Avatar">
    <div class="media-body">
       ...
       <div class="t" style="margin-left: 50px;">
