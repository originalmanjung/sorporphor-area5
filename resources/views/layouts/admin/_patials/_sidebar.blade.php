        ...
        <div class="sb-sidenav-menu">
            <div class="nav">
                ...
                @if (Auth::user()->role->slug == 'แอดมิน')
                    ...
                    <div class="collapse {{ Route::is('app.personals*') || Route::is('app.banners*') || Route::is('app.histories*') || Route::is('app.missions*') || Route::is('app.dutys*') || Route::is('app.manageStructures*')  ? 'show' : '' }}" id="collapseLayoutsWeb" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                        <nav class="sb-sidenav-menu-nested nav">
                            ...
                            <a class="nav-link {{ Route::is('app.dutys*') ? 'active' : '' }}" href="{{ route('app.dutys.index') }}">ภาระกิจหน้าที่</a>
                ...
                @if (Auth::user()->role->slug != 'โรงเรียน')
                    ...
                    <a class="nav-link collapsed {{ Route::is('app.news*') || Route::is('app.videos*') || Route::is('app.notices*') || Route::is('app.jobs*') ? 'active' : '' }}" href="#" data-bs-toggle="collapse" data-bs-target="#collapseLayoutsGeneral" aria-expanded="false" aria-controls="collapseLayoutsGeneral">
                        <div class="sb-nav-link-icon"><i class="fas fa-cogs"></i></div>
                        การใช้งานทั่วไป
                        <div class="sb-sidenav-collapse-arrow"><i class="fas fa-angle-down"></i></div>
                    </a>
                    <div class="collapse {{ Route::is('app.news*') || Route::is('app.videos*') || Route::is('app.notices*') || Route::is('app.jobs*') ? 'show' : '' }}" id="collapseLayoutsGeneral" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                        <nav class="sb-sidenav-menu-nested nav">
                    ...
                    <a class="nav-link collapsed {{ Route::is('app.intergrities*') || Route::is('app.ita*') || Route::is('app.legislations*') || Route::is('app.purchases*') || Route::is('app.paymentSlips*') || Route::is('app.budgets*') ? 'active' : '' }}" href="#" data-bs-toggle="collapse" data-bs-target="#collapseLayoutsOTA" aria-expanded="false" aria-controls="collapseLayoutsOTA">
                        <div class="sb-nav-link-icon"><i class="fas fa-tasks"></i></div>
                        ตั้งค่าส่วน ITA
                        <div class="sb-sidenav-collapse-arrow"><i class="fas fa-angle-down"></i></div>
                    </a>
                    <div class="collapse {{ Route::is('app.intergrities*') || Route::is('app.ita*') || Route::is('app.legislationLists*') || Route::is('app.legislations*') || Route::is('app.purchases*') || Route::is('app.paymentSlips*') || Route::is('app.budgets*') ? 'show' : '' }}" id="collapseLayoutsOTA" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                        <nav class="sb-sidenav-menu-nested nav">
                            <a class="nav-link {{  Route::is('app.intergrities*') ? 'active' : '' }}" href="{{ route('app.intergrities.index') }}">ITA-3</a>
