    ...
    <div class="back_re">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="title">
                        <h2 style="font-size:3vw;">คู่มือ/มาตรฐานการให้บริการสถิติการให้บริการและรายงานพึงพอใจ</h2>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            ...
            @if ($standardServices->isNotEmpty())
                ...
                <div class="col-lg-4 col-md-4 mb-4">
                    <a href="{{ route('standardServiceShow',$standardService) }}">
                        <div class="services__item d-flex align-items-center h-100">
                            <div class="services__item__icon">
                                <span><i class="fas fa-book"></i></span>
                            </div>
                            <div class="services__item__text">
                            <p style="font-size:14px;">คู่มือมาตรฐานการให้บริการสถิติการให้บริการและรายงานพึงพอใจ</p>
                            <h5>{{ $standardService->name }}</h5>
