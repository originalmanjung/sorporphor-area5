...
<div class="container-fluid px-4">
    <h1 class="mt-4">Create Popup Image</h1>
    <ol class="breadcrumb mb-4">
        <li class="breadcrumb-item active">Mange Popup Image</li>
    </ol>

    <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
            <div><i class="fas fa-table me-1"></i>สร้างรูป</div>
            <a href="{{ route('app.popupimages.index') }}" type="button" class="btn btn-danger"><i
                    class="fas fa-arrow-circle-left"></i> ย้อนกลับ</a>
        </div>
        <div class="card-body">
            <div class="row">
                <div class="col-md-7">
                    <form class="row g-3" id="popupimageFrom" popupimage="form" method="POST"
                        action="{{ isset($popupimage) ? route('app.popupimages.update',$popupimage->id) : route('app.popupimages.store') }}"
                            ...
                            <div class="row g-2">
                                <div class="col-md mb-3">
                                    ...
                                    <input type="text"
                                        ...
                                        id="name" name="name" value="{{ $popupimage->name ?? old('name') }}">
                                    @error('name')
            ...
            <div class="col-12">
                <button class="btn btn-primary"
                    onclick="showLoading(@isset($popupimage) 'กำลังอัฟเดทข้อมูล...' @else 'กำลังเพิ่มข้อมูล...' @endisset,document.getElementById('popupimageFrom').id);">
                    @isset($popupimage)
    ...
    <script>
        var upload = new FileUploadWithPreview("myUniqueUploadId", {
            ...
            @isset($popupimage->file)
            presetFiles: [
                "{{ asset('storage/popupimage_photos') }}/{{ $popupimage->file }}",
