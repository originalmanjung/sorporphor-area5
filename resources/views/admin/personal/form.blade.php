                            ...
                            <div class="row g-2">
                                <div class="mb-3">
                                    ...
                                    <select id="inputState" class="form-select @error('group') is-invalid @enderror" name="group">
                                        ...
                                        <option value="กลุ่มบริหารงานการเงินและสินทรัพย์" @if(isset($personal)) {{ $personal->group == 'กลุ่มบริหารงานการเงินและสินทรัพย์' ? 'selected' : '' }} @else {{ old('group') == 'กลุ่มบริหารงานการเงินและสินทรัพย์' ? 'selected':'' }} @endif>กลุ่มบริหารงานการเงินและสินทรัพย์</option>
