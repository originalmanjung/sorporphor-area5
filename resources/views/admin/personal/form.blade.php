                        ...
                        <div clas="row g-2">
                            <div class="row g-2">
                                <div class="mb-3">
                                    ...
                                    <select id="inputState" class="form-select @error('group') is-invalid @enderror" name="group">
                                        <option value="" @if(empty($personal->group)) selected @endif >Choose...</option>
                                        <option value="ผู้บริหาร" @if(isset($personal)) {{ $personal->group == 'ผู้บริหาร' ? 'selected' : '' }} @else {{ old('group') == 'ผู้บริหาร' ? 'selected':'' }} @endif>ผู้บริหาร</option>
                                        <option value="กลุ่มอำนวยการ" @if(isset($personal)) {{ $personal->group == 'กลุ่มอำนวยการ' ? 'selected' : '' }} @else {{ old('group') == 'กลุ่มอำนวยการ' ? 'selected':'' }} @endif>กลุ่มอำนวยการ</option>
                                        <option value="กลุ่มนโยบายและแผน" @if(isset($personal)) {{ $personal->group == 'กลุ่มนโยบายและแผน' ? 'selected' : '' }} @else {{ old('group') == 'กลุ่มนโยบายและแผน' ? 'selected':'' }} @endif>กลุ่มนโยบายและแผน</option>
                                        <option value="กลุ่มบริหารงานบุคคล" @if(isset($personal)) {{ $personal->group == 'กลุ่มบริหารงานบุคคล' ? 'selected' : '' }} @else {{ old('group') == 'กลุ่มบริหารงานบุคคล' ? 'selected':'' }} @endif>กลุ่มบริหารงานบุคคล</option>
                                        <option value="กลุ่มบริหารงานการเงินและสินทรัพย์" @if(isset($personal)) {{ $personal->group == 'กลุ่มบริหารงานการเงินและสินทรัพย์' ? 'selected' : '' }} @else {{ old('group') == 'กลุ่มบริหารงานการเงินและสินทรัพย์' ? 'selected':'' }} @endif>กลุ่มบริหารการเงินและสินทรัพย์</option>
                                        <option value="กลุ่มส่งเสริมการจัดการศึกษา" @if(isset($personal)) {{ $personal->group == 'กลุ่มส่งเสริมการจัดการศึกษา' ? 'selected' : '' }} @else {{ old('group') == 'กลุ่มส่งเสริมการจัดการศึกษา' ? 'selected':'' }} @endif>กลุ่มส่งเสริมการจัดการศึกษา</option>
                                        <option value="กลุ่มพัฒนาครูและบุคลากรทางการศึกษา" @if(isset($personal)) {{ $personal->group == 'กลุ่มพัฒนาครูและบุคลากรทางการศึกษา' ? 'selected' : '' }} @else {{ old('group') == 'กลุ่มพัฒนาครูและบุคลากรทางการศึกษา' ? 'selected':'' }} @endif>กลุ่มพัฒนาครูและบุคลากรทางการศึกษา</option>
                                        <option value="กลุ่มนิเทศติดตามและประเมินผลการจัดการศึกษา" @if(isset($personal)) {{ $personal->group == 'กลุ่มนิเทศติดตามและประเมินผลการจัดการศึกษา' ? 'selected' : '' }} @else {{ old('group') == 'กลุ่มนิเทศติดตามและประเมินผลการจัดการศึกษา' ? 'selected':'' }} @endif>กลุ่มนิเทศติดตามและประเมินผลการจัดการศึกษา</option>
                                        <option value="กลุ่มส่งเสริมการศึกษาทางไกลเทคโนโลยีสารสนเทศและการสื่อสาร" @if(isset($personal)) {{ $personal->group == 'กลุ่มส่งเสริมการศึกษาทางไกลเทคโนโลยีสารสนเทศและการสื่อสาร' ? 'selected' : '' }} @else {{ old('group') == 'กลุ่มส่งเสริมการศึกษาทางไกลเทคโนโลยีสารสนเทศและการสื่อสาร' ? 'selected':'' }} @endif>กลุ่มส่งเสริมการศึกษาทางไกลเทคโนโลยีสารสนเทศและการสื่อสาร</option>
                                        <option value="หน่วยตรวจสอบภายใน" @if(isset($personal)) {{ $personal->group == 'หน่วยตรวจสอบภายใน' ? 'selected' : '' }} @else {{ old('group') == 'หน่วยตรวจสอบภายใน' ? 'selected':'' }} @endif>หน่วยตรวจสอบภายใน</option>
                                        <option value="กลุ่มกฎหมายและคดี" @if(isset($personal)) {{ $personal->group == 'กลุ่มกฎหมายและคดี' ? 'selected' : '' }} @else {{ old('group') == 'กลุ่มกฎหมายและคดี' ? 'selected':'' }} @endif>กลุ่มกฎหมายและคดี</option>
                                    </select>
                                    @error('group')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                            ...
                            <div class="mb-3">
                                ...
                                <select id="inputState" class="form-select @error('position_general') is-invalid @enderror" name="position_general">
                                    ...
                                    <option value="ผู้อำนวยการกลุ่มบริหารงานการเงินและสินทรัพย์" @if(isset($personal)) {{ $personal->position_general == 'ผู้อำนวยการกลุ่มบริหารงานการเงินและสินทรัพย์' ? 'selected' : '' }} @else {{ old('position_general') == 'ผู้อำนวยการกลุ่มบริหารงานการเงินและสินทรัพย์' ? 'selected':'' }} @endif>ผู้อำนวยการกลุ่มบริหารการเงินและสินทรัพย์</option>
