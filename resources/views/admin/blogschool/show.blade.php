...
<div class="container">
    <div class="row">
        ...
        <a href="{{ route('app.blogSchools.index') }}" type="button" class="btn btn-danger mb-3"><i class="fas fa-arrow-circle-left"></i> ย้อนกลับ</a>
            <div class="text-center card-box">
                <div class="member-card">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">{{ $blogSchool->description }}</p>
                        </div>
                        </div>
                </div>
            </div> <!-- end card-box -->
                             ...
                             @foreach ($blogSchool->blogSchoolPhotos as $key=>$photos )
                                <div class="col-sm-3">
                                    <div class="gal-detail thumb">
                                        <a href="{{ asset('storage/blogschool_photos/'.$photos->filename) }}" class="image-popup fancybox" rel="ligthbox" title="Screenshot-2">
                                            <img src="{{ asset('storage/blogschool_photos/'.$photos->filename) }}" class="thumb-img" alt="work-thumbnail">
                                        </a>
